...
<body>
    ...
    <div class="container">
        <div class="card p-5">
            ...
            <form method="post" class="mt-3" id="passForm">
                <div class="row g-3">
                    <div class="col-sm-12">
                        <div class="form-floating">
                            <input type="tel" class="form-control" id="currentTel" name="currentTel" placeholder="" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required>
                            <label for="currentTel">Current Phone Number</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="password" class="form-control" id="currentPass" name="currentPass" placeholder="">
    ...
    <script>
        ...
        function updateTel() {
            var fd = new FormData(jQuery('form#passForm')[0]);
